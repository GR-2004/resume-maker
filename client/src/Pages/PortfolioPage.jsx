...
const PortfolioPage = ({ dataObject, imagePreview }) => {
  const options = {
  ...
  return (
    <div className="lg:w-3/5 w-full min-h-screen px-6 mx-auto bg-gray-100">
      <div
        ref={contentRef}
      ...
      >
        <div className="flex items-center mb-8">
          <div className="flex-shrink-0 mr-8">
            <img
              src={imagePreview? imagePreview : dataObject.image}
              alt="resume-image"
